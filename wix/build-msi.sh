...
LDFLAGS="github.com/machship-mm/cloud-print-connector/lib.BuildDate=$CONNECTOR_VERSION"
...
echo "Running go get..."
go get -ldflags -X="$LDFLAGS" -v github.com/machship-mm/cloud-print-connector/...
rc=$?
if [[ $rc != 0 ]]; then
